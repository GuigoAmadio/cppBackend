...
void AuditLogRepository::log(
    ...
    // Por enquanto, usar apenas colunas que têm valor
    // TODO: Implementar suporte adequado para NULL em UUIDs opcionais
    if (!userId.has_value()) {
        LOG_WARNING("Audit log without user_id - skipping");
        return;
    }
